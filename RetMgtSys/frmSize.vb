...
Public Class frmSize
    Private Const pxeTableName As String = "Size"

    Private pnLoadx As Integer
    Private poControl As Control

    Private WithEvents p_oRecord As clsSize
    ...
    Private Sub frmBin_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        If pnLoadx = 0 Then
            p_oRecord = New clsSize(p_oAppDriver, True)
...
endProc:
    ...
    Private Sub loadMaster()
        With p_oRecord
            ...
            txtField00.Text = .Master("sSizeIDxx")
            txtField01.Text = .Master("sSizeName")
