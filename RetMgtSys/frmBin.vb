...
Public Class frmBin
    Private Const pxeTableName As String = "Bin"

    Private pnLoadx As Integer
    Private poControl As Control

    Private WithEvents p_oRecord As clsBin
    ...
    Private Sub frmBin_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        If pnLoadx = 0 Then
            p_oRecord = New clsBin(p_oAppDriver, True)
...
endProc:
    ...
    Private Sub loadMaster()
        With p_oRecord
            ...
            txtField00.Text = .Master("sBinIDxxx")
            txtField01.Text = .Master("sBinNamex")
