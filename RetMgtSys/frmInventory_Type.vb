...
Public Class frmInventory_Type
    Private Const pxeTableName As String = "Inventory_Type"

    Private pnLoadx As Integer
    Private poControl As Control

    Private WithEvents p_oRecord As clsInvType
    Private p_nEditMode As Integer

    Private Sub frmInventory_Type_Activated(sender As Object, e As System.EventArgs) Handles Me.Activated
        If pnLoadx = 1 Then
            pnLoadx = 2
        End If
    End Sub

    Private Sub frmInventory_Type_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmInventory_Type_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        If pnLoadx = 0 Then
            p_oRecord = New clsInvType(p_oAppDriver, True)
...
endProc:
    ...
    Private Sub loadMaster()
        With p_oRecord
            ...
            txtField00.Text = .Master("sInvTypCd")
