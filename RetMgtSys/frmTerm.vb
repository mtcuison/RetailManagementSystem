...
Public Class frmTerm
    Private Const pxeTableName As String = "Banks"

    Private pnLoadx As Integer
    Private poControl As Control

    Private WithEvents p_oRecord As clsTerm
    ...
    Private Sub frmBank_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        If pnLoadx = 0 Then
            p_oRecord = New clsTerm(p_oAppDriver, True)
...
endProc:
    ...
    Private Sub loadMaster()
        With p_oRecord
            ...
            txtField00.Text = .Master("sTermIDxx")
            txtField01.Text = .Master("sTermName")
            txtField02.Text = .Master("nTermDays")
            txtField03.Text = .Master("nDiscDays")
            txtField04.Text = .Master("nDiscount")
