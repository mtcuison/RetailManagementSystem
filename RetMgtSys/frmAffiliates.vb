...
Public Class frmAffiliates
    Private Const pxeTableName As String = "Affiliated_Company"

    Private pnLoadx As Integer
    Private poControl As Control

    Private WithEvents p_oRecord As clsCompanyAffiliates
    ...
    Private Sub frmBank_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        If pnLoadx = 0 Then
            p_oRecord = New clsCompanyAffiliates(p_oAppDriver, True)
...
endProc:
    ...
    Private Sub loadMaster()
        With p_oRecord
            ...
            txtField00.Text = .Master("sCompnyCd")
            txtField01.Text = .Master("sCompnyNm")
            txtField02.Text = Format(.Master("dAffiliat"), "MMM dd, yyyy")
    ...
    Private Sub chkField_Click(sender As Object, e As System.EventArgs) Handles chkField.Click
        p_oRecord.Master(3) = IIf(chkField.Checked, 1, 0)
    End Sub
End Class